...
class Range_Field extends Text_Field {
	/**
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'carbon-field-range', $root_uri . '/build/bundle.css' );

		// Enqueue field scripts.
		wp_enqueue_script( 'carbon-field-range', $root_uri . '/build/bundle.js', array( 'carbon-fields-core' ) );
	}
}
